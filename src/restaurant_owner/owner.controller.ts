...
export async function getAllOwner(c: Context) {
...
export async function getOneOwner(c: Context) {
...
export async function addOwner(c: Context) {
...
export async function updateOwner(c: Context) {
  const id = Number(c.req.param("id"));
...
export async function deleteOwner(c: Context) {
  const id = Number(c.req.param("id"));
