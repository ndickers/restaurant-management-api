...
import { z } from "zod";
import { getAllOrderStatus, addOrderStatus, getOneOrderStatus, updateOrderStatus, deleteStatusOrder, } from "./order_status.controller";
...
orderStatusRoute.post("/order-status", zValidator("json", inputOrderStatus, (result, c) => {
    if (result.success) {
