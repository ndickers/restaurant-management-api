...
import { getAllUsers, getOneUser, addNewUser, updateWholeUser, deleteUser, } from "./users.controller";
...
userRoute.post("/users", zValidator("json", inputUserData, (result, c) => {
    console.log();
    if (!result.success) {
